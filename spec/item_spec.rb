  ...
  describe '#initialize' do
    ...
    context 'when calculating sales tax and price with tax' do
      context 'when the item is exempted from tax' do
        ...
        context 'when the item belongs to book category' do
          let(:name) { 'book' }
        ...
        context 'when the item belongs to food category' do
          let(:name) { 'chocolate' }
        ...
        context 'when the item belongs to medical products category' do
